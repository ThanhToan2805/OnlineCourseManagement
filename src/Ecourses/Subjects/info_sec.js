        ...
        const staticCourses = [
            {
                tenkh: 'An ninh mạng',
                anh: 'course-4.jpg',
                ngaybatdau: '2024-09-13',
                ngayketthuc: '2024-12-27'
            },
        ];
            ...
            <div className="container-fluid page-header" style={{marginBottom: "90px"}}>
                <div className="container">
                    <div className="d-flex flex-column justify-content-center" style={{minHeight: "300px"}}>
                        <h3 className="display-4 text-white text-uppercase">An toàn thông tin</h3>
                        <div className="d-inline-flex text-white">
                            <p className="m-0 text-uppercase"><a className="text-white" href="/">Trang chủ</a></p>
                            <i className="fa fa-angle-double-right pt-1 px-3"></i>
                            <p className="m-0 text-uppercase">An toàn thông tin</p>
                        </div>
                    </div>
                </div>
            </div>
